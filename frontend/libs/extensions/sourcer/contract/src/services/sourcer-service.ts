...
// ISourcerService is the runtime-light contract the Sourcer pages and components
...
// SOURCER_SERVICE token below. The shared BaseListPage additionally needs the
